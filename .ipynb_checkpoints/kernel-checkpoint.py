...
def inflations(x_train,y_train,real_x_test,real_y_test):    
    for i,l in enumerate(y_train[30000:]):
        ...
        time.sleep(1)
def margins(predict_score,x_train,y_train,real_x_test,real_y_test):
    for i,l in enumerate(y_train[30000:]):
...
#     thread_2 = threading.Thread(target=margins(predict_score,x_train,y_train,real_x_test,real_y_test))
    ...
    #executor.submit(inflations(x_train,y_train,real_x_test,real_y_test))
    executor.submit(margins(predict_score,x_train,y_train,real_x_test,real_y_test))
